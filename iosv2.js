        ...
        window.addEventListener('load', function() {
			...
			btnDebug.onclick = function() {
			  ...
			  if (lrInnerDoc) {
					...
					if (panel) {
						var cs = lrInnerDoc.defaultView.getComputedStyle(panel);
						var rect = panel.getBoundingClientRect();
						out += 'panel found: id=' + panel.id + ' position=' + cs.position + ' display=' + cs.display + ' width=' + rect.width + ' | parentTag=' + panel.parentElement.tagName;
					} else {
